...
add_action( 'wp_footer', 'countrytheme_include_svg_icons', 9999 );
...
function countrytheme_get_svg(array $args = array() ): string
{
	...
	if ( false === array_key_exists( 'icon', $args ) ) {
		return __( 'Please define an SVG icon filename.', 'countrytheme' );
	}
	 ...
	 *
	 * Example 1 with title: <?php echo countrytheme_get_svg( array( 'icon' => 'arrow-right', 'title' => __( 'This is the title', 'textdomain' ) ) ); ?>
	 *
	 * Example 2 with title and description: <?php echo countrytheme_get_svg( array( 'icon' => 'arrow-right', 'title' => __( 'This is the title', 'textdomain' ), 'desc' => __( 'This is the description', 'textdomain' ) ) ); ?>
	 *
...
function countrytheme_social_links_icons(): array
{
	 ...
	 */
	return apply_filters( 'countrytheme_social_links_icons', $social_links_icons );
}
